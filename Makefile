...
run:
	docker run -p 28017:28017 -p 8080:8080 -p 29017:29017 --name $(subst /,-,$(NAME)) --restart=always -t --cidfile cidfile -d $(NAME):$(VERSION) /sbin/runit
...
version:
	...
	docker run -it --rm $(NAME):$(VERSION) sh -c " rethinkdb --version " | tee -a COMPONENTS
	dos2unix COMPONENTS
